...
def notification(alert=None, ios=None, android=None, winphone=None):
    ...
    :keyword android: An Android platform override,
                      as generated by :py:func:`android`.
    :keyword winphone: A MPNS platform override,
                      as generated by :py:func:`mpns`.
...
def winphone(alert, title=None, _open_page=None, extras=None):
    ...
    Must include exactly one of:
        `alert`, `title`, `_open_page`, or `extras`.
    """
